...
func TestEncode(t *testing.T) {
	...
	// Emulated this value already exist in DB,
	// so need to add one more symbol to key
	mock.ExpectGet("NcaA").SetVal("value")

	for _, tt := range TestData {
		t.Run(fmt.Sprintf("Encode %d", tt.number), func(t *testing.T) {
			result := encode(tt.number, db)
...
var TestData = []TestCase{
	...
	{number: 15000000, encodedStr: "jkAG"},
	{number: 100000000, encodedStr: "tWAk"},
	...
	{number: 18176449534139642514, encodedStr: "NcaAu"},
	...
	{number: 18446744073709551615, encodedStr: "sDC7"},
}
